            ...
            if ($('#customer_project_list').length > 0) {
                $('#customer_project_list').DataTable({
                    ...
                    initComplete: (settings, json) => {
                        $('.dataTables_paginate').appendTo('.customer_project_list_datatable_paginate');
                        $('.dataTables_length').appendTo('.customer_project_list_datatable_length');
                    },
                    ajax: {
                        url: $('#customer_project_list').data('url'),
                        type: "GET",
                        data: function (d) {
                            d.customer_id = @json($customer->id);
                        },
