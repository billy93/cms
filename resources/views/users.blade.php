...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-4">
                                    <form class="icon-form mb-3 mb-sm-0" id="c_user_list_search_form">
                                        <span class="form-icon"><i class="ti ti-search"></i></span>
                                        <input type="text" class="form-control" placeholder="Search User" id="c_user_list_search_input">
                                    </form>							
                                </div>		
                                <div class="col-sm-8">
                                    <div class="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
                                        ...
                                        <a href="javascript:void(0);" id="c_user_create_btn" class="btn btn-primary"><i class="ti ti-square-rounded-plus me-2"></i>Add New User</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /Search -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive custom-table">
                                <table class="table" id="user_list" data-url="{{ route('users.index') }}">
                                    <style>
                                        ...
                                        <tr>
                                            <th class="td-break no-sort">
                                                <label class="checkboxs">
                                                    <input type="checkbox" id="select_all_user_list">
	...
	@include('components.users.create-modal')
	@include('components.users.modal')
	@include('components.users.change-password-modal')
@endsection

@push('scripts')
    <script>
        const HIDE_USER_DATATABLE_CHECKBOX = true;
    </script>
    <script src="/build/js/users/shared_var.js"></script>
    <script src="/build/js/users/datatables.js"></script>
    <script src="/build/js/users/events.js"></script>
    <script src="/build/js/users/change-password.js"></script>
@endpush
