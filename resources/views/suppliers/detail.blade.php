                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <h4 class="card-title mb-0" id="supplier_name_title">Supplier Detail</h4>
                            </div>
                    ...
                    <div class="card-body">
                        <!-- Tabs -->
                        <ul class="nav nav-tabs nav-tabs-solid nav-justified" id="supplierTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="info-tab" data-bs-toggle="tab" data-bs-target="#info" type="button" role="tab">
                                    <i class="ti ti-info-circle me-2"></i>Supplier Info
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="card-actions">
                                                    <a href="javascript:void(0);" class="btn btn-primary btn-sm" onclick="editSupplierInfo()">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <p id="supplier_code_display">-</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="fw-bold">Supplier Name</label>
                                                            <p id="supplier_name_display">-</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="fw-bold">Tax Number (NPWP)</label>
                                                            <p id="tax_number_display">-</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
...
$(document).ready(function() {
    let supplierId = {{ request()->route('id') }};
    ...
    function displaySupplierInfo(supplier) {
        $('#supplier_name_title').text(supplier.supplier_name);
        $('#supplier_code_display').text(supplier.supplier_code);
        $('#supplier_name_display').text(supplier.supplier_name);
        $('#contact_person_display').text(supplier.contact_person || '-');
        $('#phone_display').text(supplier.phone || '-');
        $('#email_display').text(supplier.email || '-');
        $('#tax_number_display').text(supplier.tax_number || '-');
        $('#status_display').html(`<span class="badge ${supplier.status === 'active' ? 'bg-success' : 'bg-danger'}">${supplier.status}</span>`);
        $('#address_display').text(supplier.address || '-');
        $('#bank_name_display').text(supplier.bank_name || '-');
        $('#bank_account_number_display').text(supplier.bank_account_number || '-');
        $('#bank_account_name_display').text(supplier.bank_account_name || '-');
        $('#notes_display').text(supplier.notes || '-');
    }

    // Load PICs data
    function loadPicsData() {
        $.ajax({
            url: `/api/suppliers/${supplierId}/pics`,
            method: 'GET',
            success: function(response) {
                if(response.success) {
    ...
    window.editPic = function(picId) {
        $.ajax({
            url: `/api/suppliers/${supplierId}/pics/${picId}`,
            method: 'GET',
            success: function(response) {
                if(response.success) {
    ...
    $('#confirm_delete_pic').click(function() {
        if(selectedPicId) {
            $.ajax({
                url: `/api/suppliers/${supplierId}/pics/${selectedPicId}`,
                method: 'DELETE',
                headers: {
                    'Accept': 'application/json'
                },
    ...
    // Edit supplier info function
    window.editSupplierInfo = function() {
