...
@section('content')
								...
								<div class="row align-items-center">
									...
									<div class="col-sm-8">					
										<div class="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
											...
											<a href="javascript:void(0);" id="c_project_add" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add"><i class="ti ti-square-rounded-plus me-2"></i>Add New Project</a>
										</div>
									</div>
								</div>
								<!-- /Search -->
    ...
    <!-- /Page Wrapper -->
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
			...
			<div class="offcanvas-body">
				<style>
					#c_project_form td { vertical-align: baseline; } 
				</style>
				<form id="c_project_form" method="POST"></form>
			</div>
		</div>
		<!-- /Add New Project -->
	...
	<!-- Delete Modal -->
	<div class="modal fade" id="delete_project_modal" tabindex="-1" aria-labelledby="deleteProjectModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-danger" id="confirm_delete_project">Delete</button>
				</div>
			</div>
		</div>
	</div>
