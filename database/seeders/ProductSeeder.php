    ...
    public function run(): void
    {
        ...
        foreach ($products as $item) {
            $product = Product::create([
                ...
                'unit' => $item['unit'],
                'base_cost' => $item['base_cost'], // string sesuai format mutator
